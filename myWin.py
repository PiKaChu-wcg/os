...
class mywin(QMainWindow):
    ...
    def initUI(self,shape):
        ...
        self.btn1.move(shape[0]*0.5+220,100)
        self.btn1.clicked.connect(self.query)

        self.qle1=QLineEdit(self)
        self.qle1.move(shape[0]*0.5+20,100)
        self.qle1.resize(150,30)
        self.qle1.setPlaceholderText("内存地址")

        self.lb1=QLabel(self)
        self.lb1.setText("缺页率:0/0  0%")
        self.lb1.move(shape[0]*0.5+220,200)
        self.lb1.resize(150,30)

        # self.btn2=QPushButton("查看地址分配",self)
        # self.btn2.move(360,200)
        # self.btn2.clicked.connect(self.myshow)        
        
        # self.btn3=QPushButton("查看逻辑地址",self)
        # self.btn3.move(360,300)
        # self.btn3.clicked.connect(self.myshow)
        
        # self.btn4=QPushButton("调用内存",self)
        # self.btn4.move(530,200)
        # self.btn4.clicked.connect(self.turn)

        # self.lb=QLabel(self)
        # self.lb.move(360,400)
        # self.lb.setText("")
